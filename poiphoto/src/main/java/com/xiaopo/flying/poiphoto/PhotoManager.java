...
public class PhotoManager {
    ...
    private final List<String> mBucketIds;
    private final int numberOfPics = 0;
    ...
    public List<Album> getAlbum() {
        ...
        Cursor cursor = mContentResolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projects, null, null, null);
...
//                , MediaStore.Images.Media.DATE_MODIFIED);
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                album.setCoverPath(getPhoto(buckedId).get(0).getPath());
                album.addpics();
