...
public class PuzzleView extends View {
  ...
  private final List<PuzzlePiece> puzzlePieces = new ArrayList<>();
  private final List<PuzzlePiece> needChangePieces = new ArrayList<>();
  private final Map<Area, PuzzlePiece> areaPieceMap = new HashMap<>();
  ...
  private final Runnable switchToSwapAction = new Runnable() {
    @Override
    public void run() {
      if (!canSwap) return;
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    selectedLineColor =
            ta.getColor(R.styleable.PuzzleView_selected_line_color, Color.WHITE);
    handleBarColor =
            ta.getColor(R.styleable.PuzzleView_handle_bar_color, Color.WHITE);
